import type { ConfigCommandDeps } from "@/commands/config";
import {
  getConfigValue,
  parseConfigKey,
  parseConfigUpdate,
...
import { parseConfigOverrideWithDiagnostics } from "@/lib/config";
import {
...
export async function runGet(args: string[], deps: ConfigCommandDeps): Promise<void> {
...
export async function runSet(args: string[], deps: ConfigCommandDeps): Promise<void> {
